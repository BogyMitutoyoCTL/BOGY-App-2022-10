...
class _TopicQuestionState extends State<TopicQuestion> {
  String questionName() {
    if (widget.question.questionType == QuestionTypes.stringAndAnswers) {
  ...
  void editQuestion() {
    Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => EditQuestion(widget.question)));
  }

  void Loeschen() {
    widget.questionstack.removeQuestion(widget.question);
